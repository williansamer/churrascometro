...
let botao = document.querySelector(".b");
let resultado = document.querySelector(".results");
let fundoDoResultado = document.querySelector(".imgBbq");
...
let qtddCarneAdulto1 = 500;
let qtddCarneCrianca1 = qtddCarneAdulto1 / 2;
let qtddCarneAdulto2 = 700;
let qtddCarneCrianca2 = qtddCarneAdulto2 / 2;
let qtddCerveja1 = 1200;
let qtddCerveja2 = 2000;
...
let refrigerante = "";
  ...
  fundoDoResultado.style.display = "none";
  }
  ...
  function conta(){
    ...
    if(inpDr.value < 6){
      ...
      fundoDoResultado.style.display = "block";
    } else{
